#
#  Be sure to run `pod spec lint GiphySwift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Matias Seijas" => "matiseijas@gmail.com" }
  s.social_media_url   = "http://twitter.com/mseijas_"
  ...
  s.source       = { :git => "https://github.com/sunchongyang/GiphySwift.git", :tag => "#{s.version}" }
